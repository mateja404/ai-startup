...
const BentoFeatures = () => {
  return (
    <section className='w-full h-auto flex flex-col gap-y-7 justify-center items-center pt-20'>
        <p className='text-white max-w-2xl text-center text-2xl xl:text-4xl'>Harness the power of AI, making search engine optimization intuitive and effective for all skill levels.</p>
        <div className='w-[80%] h-full flex flex-col xl:flex-row gap-x-3 gap-y-3'>
            <div className='w-full xl:w-[30%] h-auto bg-transparent border-1 border-zinc-700 rounded-xl flex flex-col gap-y-5 p-5'>
            ...
            <div className='w-full xl:w-[70%] h-auto relative bg-transparent border-1 border-zinc-700 rounded-xl flex flex-col p-5'>
